...
%% Make lists of files
data_loc = [data_home '/S01_BC_Data/InPhase'];
cd(data_loc);
dat = dir('*.csv'); %Can change for TP 1 through 16/18
...
%     title('Right and Left Hand Phase Angle ')
%     xlabel('Time')
%     ylabel('Angle (degrees)')
%     legend('Right Hand', 'Left Hand', 'location', 'southeast')
%     
    %bottom plot
    nexttile
    plot(ContRelPhase)
